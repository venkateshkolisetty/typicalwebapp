...
public class ClientUtilServiceimpl extends TypicalWebAppSourceBean implements ClientUtilService {
	...
	public ClientUtilServiceimpl(String beanName) {
		super(beanName);
	}
	...
	public void logRequestDetails(HttpServletRequest httpServletRequest) {
		...
		log.trace("{}{}{}{}{}", httpServletRequest.getRequestURL(), TypicalWebAppConstants.SPACE_AROUND_SINGLE_COLUN,
				httpServletRequest.getMethod(), TypicalWebAppConstants.SPACE_AROUND_DOUBLE_COLUN, new Date());
	...
	public void logClientDetails(HttpServletRequest httpServletRequest) {
		...
		log.trace("Client{}{}{}{}{}{}", TypicalWebAppConstants.SPACE_AROUND_DOUBLE_COLUN,
				httpServletRequest.getRemoteHost(), TypicalWebAppConstants.SPACE_AROUND_DOUBLE_COLUN, userAgent.getId(),
				TypicalWebAppConstants.SPACE_AROUND_DOUBLE_COLUN, userAgent.toString());
		...
		while (headerNames.hasMoreElements()) {
			...
			clientDetailsStringBuffer
					.append(paramName + TypicalWebAppConstants.SPACE_AROUND_DOUBLE_COLUN + paramValue + LINE_SEPARATOR);
		}
